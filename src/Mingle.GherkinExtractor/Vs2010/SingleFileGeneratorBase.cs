...
namespace Mingle.GherkinExtractor.Vs2010
{
    ...
    public abstract class SingleFileGeneratorBase : IVsSingleFileGenerator, IObjectWithSite
    {
        ...
        protected virtual CodeDomProvider GetCodeProvider()
        {
            ...
            {
                var provider = GetService(typeof(SVSMDCodeDomProvider))
        ...
        protected virtual void RefreshMsTestWindow()
        {
            ...
            if (cmdTarget != null)
                cmdTarget.Exec(ref refreshCmdGuid, cmdID, (uint)OLECMDEXECOPT.OLECMDEXECOPT_DONTPROMPTUSER, IntPtr.Zero, IntPtr.Zero);
        }
